...
<body>
	...
	<div class="container">
		<form class="form-horizontal" method="post" action="user.do" name=form enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<img <%if (emp.getUser_profile().equals("null")) {%> src="upload/semiDummy/nomal.jpg" <%} else {%> src="/semiProject/upload/<%=emp.getUser_profile()%>" <%}%>
			...
			<div class="col-sm-7">
					<img <%if (emp.getUser_header().equals("null")) {%> src="upload/semiDummy/back.jpg" <%} else {%> src="/semiProject/upload/<%=emp.getUser_header()%>" <%}%> 
					class="img-thumbnail" id="UploadedBack" style="height: 200px; width: 500px" />
					<input type="hidden" id = "background" name="background" value="<%=emp.getUser_header()%>"/>
				</div>
				<div class="col-sm-2">
		...
		<form action="user.do" name="delform" method="post">
