...
<%
	...
	Nicknamechk manager = Nicknamechk.getInstance();
	int check = manager.confirmId(nick); // confirmId 결과인 숫자 1 또는 -1을 받아옴
%>
<body>
	<% if (check == 1) { // 받아온 숫자가 1이면 중복 %> 
	<form class="form-horizontal" action="UpdateNicknamechk.jsp" name="form1" method="post">
	...
	<script type="text/javascript">
		...
		function setid2() {
			...
			opener.document.form.Viewnickname.value = "<%=nick%>";
			self.close();
		}
	</script>
</body>
